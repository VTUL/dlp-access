...
export default function CollectionCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCollection_category(initialValues.collection_category);
    setCollectionmap_id(initialValues.collectionmap_id);
    setCollectionOptions(initialValues.collectionOptions);
    ...
    setExplicit_content(initialValues.explicit_content);

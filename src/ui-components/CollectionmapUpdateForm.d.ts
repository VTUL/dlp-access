...
export declare type CollectionmapUpdateFormProps = React.PropsWithChildren<{
    ...
    id?: string;
    collectionmap?: any;
    onSubmit?: (fields: CollectionmapUpdateFormInputValues) => CollectionmapUpdateFormInputValues;
    onSuccess?: (fields: CollectionmapUpdateFormInputValues) => void;
    onError?: (fields: CollectionmapUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: CollectionmapUpdateFormInputValues) => CollectionmapUpdateFormInputValues;
    onValidate?: CollectionmapUpdateFormValidationValues;
} & React.CSSProperties>;
export default function CollectionmapUpdateForm(props: CollectionmapUpdateFormProps): React.ReactElement;

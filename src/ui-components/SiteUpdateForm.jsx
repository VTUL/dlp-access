...
export default function SiteUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = siteRecord
      ? { ...initialValues, ...siteRecord }
      : initialValues;
    setAnalyticsID(cleanValues.analyticsID);
    setAssetBasePath(cleanValues.assetBasePath);
    setBrowseCollections(
      typeof cleanValues.browseCollections === "string" ||
        cleanValues.browseCollections === null
        ? cleanValues.browseCollections
        : JSON.stringify(cleanValues.browseCollections)
    );
    setContact(cleanValues.contact ?? []);
    setCurrentContactValue("");
    setDisplayedAttributes(
      typeof cleanValues.displayedAttributes === "string" ||
        cleanValues.displayedAttributes === null
        ? cleanValues.displayedAttributes
        : JSON.stringify(cleanValues.displayedAttributes)
    );
    setGroups(cleanValues.groups ?? []);
    setCurrentGroupsValue("");
    setHomePage(
      typeof cleanValues.homePage === "string" || cleanValues.homePage === null
        ? cleanValues.homePage
        : JSON.stringify(cleanValues.homePage)
    );
    setLang(cleanValues.lang);
    setMiradorOptions(
      typeof cleanValues.miradorOptions === "string" ||
        cleanValues.miradorOptions === null
        ? cleanValues.miradorOptions
        : JSON.stringify(cleanValues.miradorOptions)
    );
    setSearchPage(
      typeof cleanValues.searchPage === "string" ||
        cleanValues.searchPage === null
        ? cleanValues.searchPage
        : JSON.stringify(cleanValues.searchPage)
    );
    setSiteColor(cleanValues.siteColor);
    setSiteId(cleanValues.siteId);
    setSiteName(cleanValues.siteName);
    setSiteOptions(
      typeof cleanValues.siteOptions === "string" ||
        cleanValues.siteOptions === null
        ? cleanValues.siteOptions
        : JSON.stringify(cleanValues.siteOptions)
    );
    setSitePages(
      typeof cleanValues.sitePages === "string" ||
        cleanValues.sitePages === null
        ? cleanValues.sitePages
        : JSON.stringify(cleanValues.sitePages)
    );
    setSiteTitle(cleanValues.siteTitle);
    setErrors({});
  };
  ...
  React.useEffect(resetStateValues, [siteRecord]);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          assetBasePath: assetBasePath ?? null,
          browseCollections,
          contact,
          displayedAttributes,
          groups: groups ?? null,
          homePage,
          lang: lang ?? null,
          miradorOptions: miradorOptions ?? null,
          searchPage,

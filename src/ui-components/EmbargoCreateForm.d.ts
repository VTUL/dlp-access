...
export declare type EmbargoCreateFormProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: EmbargoCreateFormInputValues) => EmbargoCreateFormInputValues;
    onSuccess?: (fields: EmbargoCreateFormInputValues) => void;
    onError?: (fields: EmbargoCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: EmbargoCreateFormInputValues) => EmbargoCreateFormInputValues;
    onValidate?: EmbargoCreateFormValidationValues;
} & React.CSSProperties>;
export default function EmbargoCreateForm(props: EmbargoCreateFormProps): React.ReactElement;

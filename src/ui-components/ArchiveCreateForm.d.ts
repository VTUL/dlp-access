...
export declare type ArchiveCreateFormProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: ArchiveCreateFormInputValues) => ArchiveCreateFormInputValues;
    onSuccess?: (fields: ArchiveCreateFormInputValues) => void;
    onError?: (fields: ArchiveCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: ArchiveCreateFormInputValues) => ArchiveCreateFormInputValues;
    onValidate?: ArchiveCreateFormValidationValues;
} & React.CSSProperties>;
export default function ArchiveCreateForm(props: ArchiveCreateFormProps): React.ReactElement;

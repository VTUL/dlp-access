...
export declare type ArchiveCreateFormInputValues = {
  alternative?: string[];
...
export declare type ArchiveCreateFormValidationValues = {
...
export declare type ArchiveCreateFormOverridesProps = {
  ArchiveCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type ArchiveCreateFormProps = React.PropsWithChildren<
  {
    overrides?: ArchiveCreateFormOverridesProps | undefined | null;
  } & {
    clearOnSuccess?: boolean;
    onSubmit?: (
      fields: ArchiveCreateFormInputValues
    ) => ArchiveCreateFormInputValues;
    onSuccess?: (fields: ArchiveCreateFormInputValues) => void;
    onError?: (
      fields: ArchiveCreateFormInputValues,
      errorMessage: string
    ) => void;
    ...
    onValidate?: ArchiveCreateFormValidationValues;
  } & React.CSSProperties
>;
export default function ArchiveCreateForm(
  props: ArchiveCreateFormProps
): React.ReactElement;

...
import { createEmbargo } from "../graphql/mutations";
export default function EmbargoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setRecord_type(initialValues.record_type);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "EmbargoCreateForm")}
      {...rest}
    >
      <TextField
        label="Identifier"

...
export declare type CollectionmapCreateFormProps = React.PropsWithChildren<
  {
    ...
    onSubmit?: (
      fields: CollectionmapCreateFormInputValues
    ) => CollectionmapCreateFormInputValues;
...
>;
export default function CollectionmapCreateForm(
  props: CollectionmapCreateFormProps
): React.ReactElement;

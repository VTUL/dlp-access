...
import { createPageContent } from "../graphql/mutations";
export default function PageContentCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setPage_content_category(initialValues.page_content_category);
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "PageContentCreateForm")}
      {...rest}
    >
      <TextField

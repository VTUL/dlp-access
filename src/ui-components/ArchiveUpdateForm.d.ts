...
export declare type ArchiveUpdateFormProps = React.PropsWithChildren<{
    ...
    id?: string;
    archive?: any;
    onSubmit?: (fields: ArchiveUpdateFormInputValues) => ArchiveUpdateFormInputValues;
    onSuccess?: (fields: ArchiveUpdateFormInputValues) => void;
    onError?: (fields: ArchiveUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: ArchiveUpdateFormInputValues) => ArchiveUpdateFormInputValues;
    onValidate?: ArchiveUpdateFormValidationValues;
} & React.CSSProperties>;
export default function ArchiveUpdateForm(props: ArchiveUpdateFormProps): React.ReactElement;

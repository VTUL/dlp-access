describe("admin_homepage_top_config: Update Homepage fields and revert", function () {
  ...
  it("Update Homepage statement using editor", () => {
    ...
    cy.get(".ql-editor")
      .clear()
      .type(
        "A visual exhibit of selected items from the International Archive of Women in Architecture, a joint partnership between the College of Architecture and Urban Studies and the University Libraries."
      );
    cy.contains("Update Config").click();
    cy.contains(
      "A visual exhibit of selected items from the International Archive of Women in Architecture, a joint partnership between the College of Architecture and Urban Studies and the University Libraries."
  ...
  it("displays successful upload", () => {
    ...
    cy.get(".static-image > div.fileUploadField > button.uploadButton").click({
      force: true
    });
